...
from common.extensions import assistant, redis, DAILY_EXPIRE
...
def get_city_description(city: str) -> CityDescription:
    ...
    if redis.exists(city_key):
        city_description = json.loads(redis.get(city_key))
    ...
    redis.set(city_key, json.dumps(city_description.model_dump()), DAILY_EXPIRE)
